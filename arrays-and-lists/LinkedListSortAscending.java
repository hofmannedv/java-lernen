// ------------------------------------------------------------------
// Demonstrates how to sort a linked list in ascending order
//
...
// 
// Usage: java LinkedListSortAscending
// ------------------------------------------------------------------

import java.util.LinkedList;

public class LinkedListSortAscending {
    public static void main(String[] args) {
        ...
        System.out.println("sorting the data set ...");
        capital.sort(null);
